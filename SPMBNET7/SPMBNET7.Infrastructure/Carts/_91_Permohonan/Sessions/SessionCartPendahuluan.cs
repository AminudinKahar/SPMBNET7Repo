...
namespace SPMBNET7.Infrastructure.Carts._91_Permohonan.Sessions
{
    public class SessionCartPendahuluan : CartPendahuluan
    {
        public static CartPendahuluan GetCart(IServiceProvider services)
        {
            ISession session = services.GetRequiredService<IHttpContextAccessor>()?
                .HttpContext!.Session!;
            SessionCartPendahuluan cart = session?.GetJson<SessionCartPendahuluan>("CartPendahuluan") ?? new SessionCartPendahuluan();

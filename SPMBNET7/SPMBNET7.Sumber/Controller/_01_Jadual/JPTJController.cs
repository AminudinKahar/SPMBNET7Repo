...
namespace SPMBNET7.Sumber.Controller._01_Jadual
{
    ...
    public class JPTJController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            string prefix = kumpulanWang.Substring(0,2);
            int x = 1;
            string noRujukan = prefix + "0";
            ...
            {
                noRujukan = string.Format("{0:" + prefix + "0}", x);
            }
            else
            {
                x = int.Parse(LatestNoRujukan.Substring(2));
                x++;
                noRujukan = string.Format("{0:" + prefix + "0}", x);
            }
        ...
        public async Task<IActionResult> Create(JPTJ jPTJ, int JKWId)
        {
            JPTJ m = new JPTJ();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, JPTJ jPTJ, int JKWId)
        {
            if (id != jPTJ.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var perihalAsal = jPtjAsal.Perihal;

...
using SPMBNET7.App.Pages.PrintModels;
...
namespace SPMBNET7.App.Controller
{
    ...
    public class AppLogController : Microsoft.AspNetCore.Mvc.Controller
    {
            ...
            string searchDateTo)
        {
            ...
            var userList = await _context.applicationUsers.Include(x => x.SuPekerja).Where(b => b.SuPekerjaId != null).ToListAsync();
                ...
                string searchDateTo)
        {
            ...
            if (!String.IsNullOrEmpty(searchUsernamePrint) ||
                ...
                !String.IsNullOrEmpty(searchDateTo))
            {
                appLog = await _context.AppLog.Include(b => b.SuPekerja).Where(b => b.SuPekerjaId != null).ToListAsync();
            }

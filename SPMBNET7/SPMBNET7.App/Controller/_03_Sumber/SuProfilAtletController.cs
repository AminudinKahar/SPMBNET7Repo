...
namespace SPMBNET7.App.Controller._03_Sumber
{
    ...
    public class SuProfilAtletController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        private void PopulateList()
        {
            ...
            List<AkCarta> akCartaList = _context.AkCarta.Include(b => b.JKW)
                .Include(b => b.JParas)
                .Where(b => b.JParas!.Kod == "4" && b.Perihal.Contains("Skim Kecemerlangan Atlet"))
                .OrderBy(b => b.Kod)
                .ToList();
        ...
        public JsonResult JsonGetKod(string year, string month, int bahagianId)
        {
            try
            {
                ...
                var result = "A" + prefix + "/" + year + "/" + month;
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.NoRujukan = "A" + prefix + "/" + year + "/" + month;
        ...
        public JsonResult GetAnItemCartSuProfil1(SuProfil1 suProfil1)
        {
            ...
            try
            {
                ...
                var suAtlet = new SuAtlet();

                if (data != null)
                    suAtlet = _context.SuAtlet.FirstOrDefault(x => x.Id == data.SuAtletId);
        ...
        public async Task<IActionResult> Create(SuProfil suProfil, string syscode)
        {
            ...
            var IsExistNoRujukan = _context.SuProfil.FirstOrDefault(x => x.NoRujukan == suProfil.NoRujukan);

...
namespace SPMBNET7.App.Controller._01_Jadual
{
    ...
    public class JBahagianController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            var ptj = _context.JPTJ.Include(b => b.JKW).FirstOrDefault();
            var jkw = ptj?.JKW?.Kod ?? "1";

            string prefix = jkw.Substring(0,1) + ptj!.Kod;
            int x = 1;
        ...
        public async Task<IActionResult> Create(JBahagian jBahagian, string syscode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, JBahagian jBahagian, string syscode)
        {
            if (id != jBahagian.Id)
            {
                return NotFound();

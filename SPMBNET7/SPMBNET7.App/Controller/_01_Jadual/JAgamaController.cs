...
namespace SPMBNET7.App.Controller._01_Jadual
{
    ...
    public class JAgamaController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        //live data example
        //[HttpGet]
        //public IActionResult JsonGetIndexList()
        //{
        //    var res = _context.JAgama.ToList();
        //    if (User.IsInRole("SuperAdmin"))
        //    {
        //        res = _context.JAgama.IgnoreQueryFilters().ToList();
        //    }
        ...
        public async Task<IActionResult> Create(JAgama jAgama, string syscode)
        {
            if (ModelState.IsValid)
            {
                ...
                jAgama.Perihal = jAgama.Perihal?.ToUpper() ?? "";
                ...
                //await _hub.Clients.All.SendAsync("LoadJAgama");
        ...
        public async Task<IActionResult> Edit(int id, JAgama jAgama, string syscode)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var perihalAsal = objAsal!.Perihal?.ToUpper() ?? "";
        ...
        public async Task<IActionResult> DeleteConfirmed(int id, string syscode)
        {
            ...
            if (jAgama != null)
            {
                ...
                notification.Username = user?.UserName ?? "Anonymous";
                notification.Message = "Berjaya hapus data pada modul " + modul + "!";
        ...
        public async Task<IActionResult> RollBack(int id, string syscode)
        {
            ...
            Notification notification = new Notification();
            notification.Username = user?.UserName ?? "Anonymous";
            notification.Message = "Berjaya rollback data pada modul " + modul + "!";
            _context.Notification.Add(notification);
            //await _hub.Clients.All.SendAsync("LoadJAgama");
            return RedirectToAction(nameof(Index));
        }

...
namespace SPMBNET7.App.Controller._01_Jadual
{
    public class JPelulusController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public async Task<IActionResult> Create(JPelulus jPelulus,string syscode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, JPelulus jPelulus, string syscode)
        {
            if (id != jPelulus.Id)
            {
                return NotFound();
        ...
        {
            var obj = await _context.JPelulus.IgnoreQueryFilters()
